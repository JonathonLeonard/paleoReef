...
photo_file <- ifelse(length(args) > 0, args[1], "data/photozoan_filtered.csv")
photo <- read.csv(photo_file)
head(photo)
summary(photo)

# Select the name of the studied species
respName <- args[2] # e.g., 'photozoan'
...
# Read in the environmental raster dataset from args
raster_list <- args[3] # a python list of the raster files

files <- unlist(strsplit(raster_list, ","))

# Read environmental dataset
# files <- list.files(path=paste0('data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster'), pattern='.tif', full.names=TRUE )
# files <- c(
#     # 'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/runoff_annual.tif',
#     'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/upwelling_annual.tif',
#     'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/salinity_annual.tif'
#     # 'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/solar_winter.tif',
#     # 'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/solar_summer.tif',
#     'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/solar_annual.tif'
#     # 'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/SST_winter.tif',
#     # 'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/SST_summer.tif',
#     'data/rasters/2024-07-23_realigned_earthbyte_paleo_PaleomagRef_280/0Ma_envRaster/SST_annual.tif'
# )
nb_env <- length(files)
...
chosenModels <- c('GAM', 'GBM', 'GLM','MARS','RF','SRE','XGBOOST')
